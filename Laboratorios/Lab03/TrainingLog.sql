...
*/
INSERT INTO Atletas VALUES ('Aab','Anid1','+','KK');
INSERT INTO Evaluaciones VALUES (1,TO_DATE('30/06/2017','dd/mm/yyyy'),9,'Perfcecto siguio instrucciones','Bien','Eab','Enid1',1);
INSERT INTO Similitudes VALUES ('Eab','Enid1',1,'Ecd','Enid2',2,200);
INSERT INTO Actividades VALUES (1, TO_DATE('10/06/2020','dd/mm/yyyy'), 5000, 60, 85);
INSERT INTO Fotos VALUES (2, 'qwejpg');
INSERT INTO Registros VALUES (1,TO_DATE('10/06/2020','dd/mm/yyyy'),800,'X',100,1);
...
INSERT INTO Evaluaciones VALUES (1,TO_DATE('1/06/2020','dd/mm/yyyy'),4,'InPerfcecto siguio instrucciones','Bien','Erf','Enid1',1);

--Se verifica con CHK_Duracion
INSERT INTO Actividades VALUES (1, TO_DATE('10/06/2020','dd/mm/yyyy'), 700, 1441, 85);

--Severifica con CHK_hora
INSERT INTO Registros VALUES (1,TO_DATE('18/12/2010','dd/mm/yyyy'),2500,'V',100,1);

--Se verifica con el CHK_TURL
INSERT INTO Fotos VALUES (1, 'ABCDEFGpng');
...
/* INSERT QUERY NO: 23 */
INSERT INTO Sesiones(dia, orden, duracion, descripcion, atletatid, atletanid)
VALUES(4, 35, 264, 'Oth spontaneous disruption of capsular ligament of left knee', 'CE', '319710792-6');
...
VALUES
(
50, TO_DATE('14/04/2019', 'dd/mm/yyyy'), 2, 'Nondisplaced fracture of left ulna styloid process subsequent encounter for open fracture', 'muy importante', 'CE', '545671317-9',50
);
...
3. ¿Cuál consideran fue el mayor logro? ¿Por qué?
    -Insercion de checks
4. ¿Cuál consideran que fue el mayor problema técnico? ¿Qué hicieron para
resolverlo?
    -Investigacion
